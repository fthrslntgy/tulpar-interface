...
class Graphs:
    ...
    def __init__(self, widget):
        ...
        self.pl_pr_plot = pr_hei_graph.plot(pen='y', name="Görev Yükü Basınç (Pa)")
        self.pl_hei_plot = pr_hei_graph.plot(pen='r', name="Görev Yükü Yükseklik (m)")
        self.car_pr_plot = pr_hei_graph.plot(pen='b', name="Taşıyıcı Basınç (Pa)")
        self.car_hei_plot = pr_hei_graph.plot(pen='g', name="Taşıyıcı Yükseklik (m)")
